...
const PreviewCard = ({ project }) => {
  return (
    <>
      ...
      <div 
        className="hidden lg:flex w-full h-[28rem] lg:h-[32rem] rounded-2xl border border-white/20 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden flex-col bg-black/60"
      >
        {/* Website Logo & Title Section - Top */}
        <div 
          className="relative z-10 backdrop-blur-sm border-b border-white/20 p-3 md:p-4 flex-shrink-0 bg-black/60"
        >
        ...
        <div className="flex-1 relative overflow-hidden bg-black/60">
          ...
          <div className="h-full w-full bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 p-3 md:p-4 relative overflow-hidden preview-scale">
            {/* Live Preview Badge */}
...
export default function Projects() {
  ...
  return (
    <>
      ...
      <section id="projects" className="py-32 bg-[rgba(0,0,0,0.3)] relative overflow-hidden">
